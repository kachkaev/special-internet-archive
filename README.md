...
Чтобы не потерять ценные исторические данные, не забудьте периодически синхронизировать вашу коллекцию с гитхабом.

1.  Откройте терминал в папке `🗃 [project-dir-path]/data/collections/[collection-id]`.

1.  Добавьте свежие данные в гит-репозиторий и отправьте их на гитхаб:
...
1.  ![][опционально]  
    Откройте ветку с вашей коллекцией на гитхабе и убедитесь, что видите свои данные.
...
<!-- Если на последнем шаге в файле `⏳ [collection-dir-path]/url-inbox.txt` появились новые ссылки, процесса сбора и обработки данных повторится. -->
