...
> Архитектура архива позволяет работать с другими источниками и типами веб-страниц в будущем.
...
1.  Вернитесь в раздел [Регистрация веб-страниц](#регистрация-веб-страниц-в-коллекции) и продолжите с третьего пункта.
    ...
    Самый лёгкий способ актуализировать коллекцию архива описан ниже.
