...
1.  Откройте файл `[project-path]/tooling/.env.local` как текстовый и укажите путь к коллекции архива.
    ...
    Части `[project-path]` и `[collection-id]` надо заменить на настоящие, например:
...
1.  Вернитесь в раздел [Создание и обновление снимков](#создание-и-обновление-снимков) и заново пройдите всю инструкцию.
    Для только что добавленных веб-страниц надо собрать снимки, сводки снимков, комбинации сводок и аннотации.
