...
1.  Добавьте в коллекцию ссылки из файла `⏳ [collection-path]/url-inbox.txt` , как это описано в разделе [Регистрация веб-страниц списком](#регистрация-веб-страниц-списком):
