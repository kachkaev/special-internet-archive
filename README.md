...
1.  Накидайте в файл `⏳ [collection-path]/url-inbox.txt` ссылки, которые хотите зарегистрировать.
...
1.  Запустите скрипт для регистрации всех ссылок из файла `⏳ [collection-path]/url-inbox.txt`:
...
1.  ![][опционально]  
    Запустите скрипт, который удалит все зарегистрированные ссылки из файла `⏳ [collection-path]/url-inbox.txt`.
